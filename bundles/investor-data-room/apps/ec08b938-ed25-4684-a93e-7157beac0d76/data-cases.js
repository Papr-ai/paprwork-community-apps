...
window.ROOM_DATA.case_studies = [
  {
    ...
    solution: "[Your Company] gives AutoReview's AI barista a real memory layer. Every interaction is stored, indexed, and retrievable in <50ms.",
    result: 'Deployed across 30+ locations. $5,000/mo contract. Repeat order accuracy up significantly.',
    quote: "[Your Company]'s memory layer makes our AI barista actually feel intelligent. Customers notice the difference immediately.",
  ...
  },
  {
    ...
    solution: "[Your Company]'s predictive memory infrastructure lets Coda's AI remember every trust assessment. Pattern recognition improves with each interaction.",
    result: '40% reduction in false positives within 6 months. Design partner since October 2025.',
    quote: '[Company] was the only one that could handle our scale and actually predict what we needed before we asked.',
